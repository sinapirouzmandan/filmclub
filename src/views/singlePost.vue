  ...
  <div class="single">
    <div id="blur">
      ...
      <div @click="hideOptions">
        ...
        <div class="interactions">
          <vs-row>
            <vs-col w="6">
              <vs-row>
                ...
                <vs-col w="6">
                  ...
                  <br>
                  <div style="width:55px; text-align: center; font-weight: 700; margin-top:-10px; font-size: 14px;"
                       @click="$router.push(`/likes/${singlePost._id}`)">{{ likeCount }} likes
                  </div>
                </vs-col>
              </vs-row>
            </vs-col>
            <vs-col w="6">
              ...
              <div v-else-if="userProfile.role === 'reviewer'" id="reviewer">
                <vs-button
              ...
              <div v-else-if="singlePost.username === userProfile.username" id="useredit">
                <vs-button
                    :disabled="disableEdit"
                    :loading="isSaving"
                    color="rgb(70,126,246)"
        ...
        <div v-if="editMode" class="hashtags">
          <div class="hashtag_item">
            <vs-checkbox v-model="critic" primary>
              #critic
            </vs-checkbox>
          </div>
          <div class="hashtag_item">
            <vs-checkbox v-model="spoiler" danger>
              #spoilers
            </vs-checkbox>
          </div>
        </div>
        ...
        <div v-show="editMode" class="editorContainer">
