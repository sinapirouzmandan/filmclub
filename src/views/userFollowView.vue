<template>
  <div id="follow">
    ...
    <div v-show="isFollower" class="followers">
      <loading v-if="isLoading"/>
      <div v-for="(user) in userFollowers" :key="user._id" class="user">
    ...
    <div v-show="!isFollower" class="followings">
      <loading v-if="isLoading"/>
      <div v-for="(user) in userFollowings" :key="user._id" class="user">
